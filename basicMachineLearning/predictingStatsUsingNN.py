...
I am only going to use 2 neurons in the hidden layer because this is a simple NN, and with the two hidden layer neurons
and 1 output neuron I am at 48 weights
